...
const updateDisplayName = async (newDisplayName) => {
 ...
 // const dispatch = useDispatch()
  ...
  if (user) {
    ...
    // Optionally, you can update the state and dispatch the updated user information
    dispatch({
        ...
        {({ errors, handleBlur, handleChange, handleSubmit, isSubmitting, touched, values }) => (
          <form noValidate onSubmit={handleSubmit}>
            <Grid container spacing={3}>
              ...
              <Grid item xs={12}>
                <Stack spacing={1}>
                  <InputLabel htmlFor="company-signup">School Name</InputLabel>
                  <OutlinedInput
                    fullWidth
              ...
              <Grid item xs={12}>
                <Stack spacing={1}>
                  ...
                  <OutlinedInput
                    ...
                    onBlur={handleBlur}
                    onChange={handleChange}
                    placeholder="enquiry@wadabento.com"
                    inputProps={{}}
                  />
